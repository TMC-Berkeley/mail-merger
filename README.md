...
Note: You will need your Google API that is not provided in this repo saved as a file called credentials.json when you run this program locally. generateEmails.py will fail without this credential. <= Note to self... 
